...
#     ):
#         # Mock get_user_by_username as an async function
...
#             with patch("app.utils.encryption.verify_password", return_value=True):
#                 # Mock token creation
...
#                         sample_user_login, mock_database
#                     )
#
...
#         # Mock get_user_by_username as an async function returning None
#         async def mock_get_user(*args, **kwargs):
#             return None
#
#         with patch(
...
#             with patch("app.utils.encryption.verify_password", return_value=False):
#                 with pytest.raises(HTTPException) as exc_info:
#                     await AuthService.login_user(sample_user_login, mock_database)
#
#                 assert exc_info.value.status_code == 500
